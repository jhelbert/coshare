...
urlpatterns = patterns('',
    ...
    url(r'^mobile_confirm/','main.views.mobile',{"confirmed":"true"}),
    url(r'^ajax/add_album/','main.views.add_album'),
    url(r'^ajax/remove_album/','main.views.remove_album'),
    ...
    url(r'^recently_added/','main.views.go_to_recently_added'),
    url(r'^recently_favorited/','main.views.go_to_recently_favorited'),
